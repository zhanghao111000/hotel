    ...
    <form class="layui-form layui-form-pane" action="" style="margin-left: 50px;">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="roomTypeName" name="roomTypeName" placeholder="请输入房间类型名称" lay-verify="required|roomTypeName" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item" style="margin-left: 70px;margin-top: 30px;">
            <button class="layui-btn layui-btn-lg layui-btn-normal" lay-submit="" lay-filter="demo3"><i class="layui-icon">&#xe609;</i>添加房间类型</button>
        </div>
    </form>
</div>
